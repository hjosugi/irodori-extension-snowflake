//! Native connector ABI for Snowflake.
//!
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"snowflake","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"snowflake","abiVersion":1,"driverLinked":false,"manifest":"#,
